    ...
    @else
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
                ...
                <div class="bg-gradient-to-r from-sky-600 via-blue-600 to-indigo-700 rounded-2xl shadow-lg overflow-hidden relative">
                    <div class="absolute right-0 top-0 opacity-10 text-white translate-x-6 -translate-y-4">
                    ...
                    <div class="relative z-10 px-8 py-10 md:px-10 md:py-12">
                        <div class="flex flex-wrap items-center gap-3 mb-4">
                            <span class="inline-flex items-center rounded-full bg-white/15 px-4 py-1.5 text-sm font-semibold text-white border border-white/20">
                                {{ $user->role }} Access
                            </span>
                            <span class="inline-flex items-center rounded-full bg-white/15 px-4 py-1.5 text-sm font-semibold text-white border border-white/20">
                        ...
                        <p class="text-blue-100 text-base md:text-lg max-w-3xl leading-relaxed">
                        ...
                        <div class="mt-6 flex flex-wrap gap-3">
                            <a href="{{ $analyticsRoute }}" class="inline-flex items-center px-5 py-2.5 rounded-lg bg-white text-indigo-700 font-semibold shadow hover:bg-gray-100 transition">
                                View Analytics Chart
                            </a>

                            <a href="{{ route('staff.found-items.index') }}" class="inline-flex items-center px-5 py-2.5 rounded-lg bg-white/10 text-white border border-white/20 font-semibold hover:bg-white/15 transition">
                                Open Found Items
                            </a>

                            <a href="{{ route('staff.lost-items.index') }}" class="inline-flex items-center px-5 py-2.5 rounded-lg bg-white/10 text-white border border-white/20 font-semibold hover:bg-white/15 transition">
                                Open Lost Reports
                            </a>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
                    ...
                    @if($isAdmin)
                        <a href="{{ route('admin.staff.index') }}" class="bg-white rounded-2xl shadow-sm border border-gray-100 p-7 hover:shadow-xl hover:border-indigo-200 transition transform hover:-translate-y-1 group">
                            <div class="w-14 h-14 bg-indigo-100 rounded-full flex items-center justify-center mb-5 group-hover:scale-110 transition">
                            ...
                            <h3 class="text-lg font-bold text-gray-800 mb-2">Staff Management</h3>
                            <p class="text-sm text-gray-500">Create, update, block, or review staff accounts and their operational details.</p>
                        </a>

                        <a href="{{ route('admin.logs.index') }}" class="bg-white rounded-2xl shadow-sm border border-gray-100 p-7 hover:shadow-xl hover:border-slate-200 transition transform hover:-translate-y-1 group">
                            <div class="w-14 h-14 bg-slate-100 rounded-full flex items-center justify-center mb-5 group-hover:scale-110 transition">
                            ...
                            <p class="text-sm text-gray-500">Track important admin activities, changes, and historical system actions.</p>
                        </a>
                    @endif

                    <a href="{{ $analyticsRoute }}" class="bg-white rounded-2xl shadow-sm border border-gray-100 p-7 hover:shadow-xl hover:border-blue-200 transition transform hover:-translate-y-1 group">
                        <div class="w-14 h-14 bg-blue-100 rounded-full flex items-center justify-center mb-5 group-hover:scale-110 transition">
                            <svg class="w-7 h-7 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 19V6m-4 13V10m8 9V4m4 15v-7"></path>
                            </svg>
                        </div>
                        <h3 class="text-lg font-bold text-gray-800 mb-2">Analytics Chart</h3>
                        <p class="text-sm text-gray-500">View item distribution, hotspot locations, total reports, and recovery success rate.</p>
                    </a>

                    <a href="{{ route('staff.found-items.index') }}" class="bg-white rounded-2xl shadow-sm border border-gray-100 p-7 hover:shadow-xl hover:border-emerald-200 transition transform hover:-translate-y-1 group">
                        <div class="w-14 h-14 bg-emerald-100 rounded-full flex items-center justify-center mb-5 group-hover:scale-110 transition">
                            <svg class="w-7 h-7 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 8V7a2 2 0 00-2-2h-3V4a2 2 0 00-2-2h-2a2 2 0 00-2 2v1H6a2 2 0 00-2 2v1m16 0v10a2 2 0 01-2 2H6a2 2 0 01-2-2V8m16 0H4"></path>
                            </svg>
                        </div>
                        <h3 class="text-lg font-bold text-gray-800 mb-2">Found Items</h3>
                        <p class="text-sm text-gray-500">Register, review, edit, and manage all found property records in the airport system.</p>
                    </a>

                    <a href="{{ route('staff.lost-items.index') }}" class="bg-white rounded-2xl shadow-sm border border-gray-100 p-7 hover:shadow-xl hover:border-rose-200 transition transform hover:-translate-y-1 group">
                        <div class="w-14 h-14 bg-rose-100 rounded-full flex items-center justify-center mb-5 group-hover:scale-110 transition">
                        ...
                        <h3 class="text-lg font-bold text-gray-800 mb-2">Lost Reports</h3>
                        <p class="text-sm text-gray-500">Handle reported missing items, review details, and start the match verification process.</p>
                    </a>

                    <a href="{{ route('staff.claims.index') }}" class="bg-white rounded-2xl shadow-sm border border-gray-100 p-7 hover:shadow-xl hover:border-amber-200 transition transform hover:-translate-y-1 group">
                        <div class="w-14 h-14 bg-amber-100 rounded-full flex items-center justify-center mb-5 group-hover:scale-110 transition">
                        ...
                        <h3 class="text-lg font-bold text-gray-800 mb-2">Claim History</h3>
                        <p class="text-sm text-gray-500">Monitor appointment confirmation, QR verification, handover completion, and claim records.</p>
                    </a>

                    <a href="{{ route('staff.vouchers.index') }}" class="bg-white rounded-2xl shadow-sm border border-gray-100 p-7 hover:shadow-xl hover:border-cyan-200 transition transform hover:-translate-y-1 group">
                        <div class="w-14 h-14 bg-cyan-100 rounded-full flex items-center justify-center mb-5 group-hover:scale-110 transition">
                        ...
                        <h3 class="text-lg font-bold text-gray-800 mb-2">Vouchers</h3>
                        <p class="text-sm text-gray-500">Manage reward vouchers available for passenger redemption and airport loyalty incentives.</p>
                    </a>

                    <a href="{{ route('staff.ai-chat.index') }}" class="bg-white rounded-2xl shadow-sm border border-gray-100 p-7 hover:shadow-xl hover:border-violet-200 transition transform hover:-translate-y-1 group">
                        <div class="w-14 h-14 bg-violet-100 rounded-full flex items-center justify-center mb-5 group-hover:scale-110 transition">
                        ...
                        <h3 class="text-lg font-bold text-gray-800 mb-2">AI Help Assistant</h3>
                        <p class="text-sm text-gray-500">Use smart search and command shortcuts to locate records and speed up system operations.</p>
                    </a>
                </div>
                ...
                <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
                    ...
                    <div class="xl:col-span-2 bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
                        <h3 class="text-xl font-bold text-gray-800 mb-2">How the Airport Lost &amp; Found Workflow Operates</h3>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div class="rounded-xl border border-blue-100 bg-blue-50 p-5">
                                <div class="text-sm font-bold text-blue-700 mb-1">1. Receive and Register</div>
                            ...
                            <div class="rounded-xl border border-rose-100 bg-rose-50 p-5">
                                <div class="text-sm font-bold text-rose-700 mb-1">2. Review Lost Reports</div>
                                <p class="text-sm text-gray-600">
                            ...
                            <div class="rounded-xl border border-amber-100 bg-amber-50 p-5">
                                <div class="text-sm font-bold text-amber-700 mb-1">3. Verify and Schedule Claim</div>
                                <p class="text-sm text-gray-600">
                            ...
                            <div class="rounded-xl border border-emerald-100 bg-emerald-50 p-5">
                                <div class="text-sm font-bold text-emerald-700 mb-1">4. Handover and Close Case</div>
                                <p class="text-sm text-gray-600">
                    ...
                    <div class="bg-gray-50 rounded-2xl border border-gray-200 p-8">
                        <h3 class="text-xl font-bold text-gray-800 mb-4">Portal Guide</h3>

                        <div class="space-y-4 text-sm text-gray-600">
                            <div class="border-b border-gray-200 pb-4">
                                <strong class="block text-gray-800 mb-1">Dashboard Purpose</strong>
                                This page acts as a quick navigation hub for daily airport lost and found operations.
                            </div>

                            <div class="border-b border-gray-200 pb-4">
                                <strong class="block text-gray-800 mb-1">Recommended Start</strong>
                            ...
                            <div class="border-b border-gray-200 pb-4">
                                <strong class="block text-gray-800 mb-1">Claim Monitoring</strong>
                            ...
                            <div>
                                <strong class="block text-gray-800 mb-1">Operational Insight</strong>
