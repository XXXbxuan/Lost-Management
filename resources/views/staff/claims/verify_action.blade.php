    ...
    <div class="py-12">
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
                ...
                <div class="bg-white rounded-[2.5rem] shadow-xl p-8 border-t-8 border-slate-900 relative">
                    <div class="flex flex-col items-center text-center">
                        <span class="bg-slate-100 text-slate-500 text-[10px] font-black px-3 py-1 rounded-full uppercase tracking-widest mb-6">Passenger Profile</span>
                        ...
                        <div class="w-32 h-32 rounded-full bg-slate-100 border-4 border-slate-50 flex items-center justify-center mb-6 shadow-inner">
                            ...
                            {{-- 未來有照片時換成：<img src="..." class="w-full h-full rounded-full object-cover"> --}}
                        </div>
                ...
                <div class="bg-white rounded-[2.5rem] shadow-xl p-8 border-t-8 border-blue-600 relative">
                    <span class="bg-blue-100 text-blue-700 text-[10px] font-black px-3 py-1 rounded-full uppercase tracking-widest">Found Item Details</span>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="col-span-2 bg-amber-50 p-5 rounded-2xl border-2 border-amber-200">
                            <p class="text-[10px] font-black text-amber-600 uppercase tracking-widest mb-1">📍 Storage Location (Grab item here)</p>
            ...
            <div class="flex justify-center gap-6">
                <a href="{{ route('staff.claims.process', $match->id) }}" class="px-10 py-4 bg-white text-slate-400 font-bold rounded-2xl border-2 border-slate-100 hover:bg-slate-50 transition">
                    Back 
                </a>
