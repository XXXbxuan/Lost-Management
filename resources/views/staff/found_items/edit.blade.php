                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label class="block font-bold text-sm text-gray-700">Found Location <span class="text-red-500">*</span></label>
                            ...
                            <div>
                                <label class="block font-medium text-sm text-gray-700">Flight Number</label>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="description" rows="4"
                                          class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('description', $foundItem->description) }}</textarea>
                            </div>
                        </div>

                        <div class="flex justify-end gap-3 mt-8">
                            <a href="{{ route('staff.found-items.index') }}"
