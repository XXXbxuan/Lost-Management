            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mt-6">
                ...
                @if (session('success'))
                    <div x-data="{ show: true }" 
                         ...
                         class="flex items-center justify-between bg-green-100 border-l-4 border-green-500 text-green-700 p-4 rounded shadow-sm mb-4" 
                         role="alert">
                ...
                @if (session('error'))
                    <div x-data="{ show: true }" 
                         ...
                         x-transition
                         x-init="setTimeout(() => show = false, 5000)" 
                         class="flex items-center justify-between bg-red-100 border-l-4 border-red-500 text-red-700 p-4 rounded shadow-sm mb-4" 
                         role="alert">
                        <div class="flex items-center">
