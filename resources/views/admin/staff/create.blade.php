                    ...
                    <form method="POST" action="{{ route('admin.staff.store') }}">
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                >
                                    <option value="Terminal Operations" {{ old('department') == 'Terminal Operations' ? 'selected' : '' }}>
                                        Terminal Operations
                                    </option>
                        ...
                        <div class="mt-8 flex items-center justify-end gap-4 border-t pt-4">
                            <a
                                ...
                                class="text-sm text-gray-600 underline decoration-gray-400 underline-offset-4 hover:text-gray-900"
                            >
                                Cancel
                            </a>
